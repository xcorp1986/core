...
#      - https://doc.owncloud.org/server/10.0/developer_manual/general/devenv.html#check-out-the-code
#      - https://doc.owncloud.org/server/10.0/developer_manual/core/unit-testing.html#running-unit-tests-for-the-owncloud-core-project
#
